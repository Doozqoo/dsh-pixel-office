  ...
  return (
    <section className="pxo-settings" aria-labelledby="pxo-settings-title">
      <div className="pxo-settings-hero">
        ...
        <p>调整任务矩阵密度、环境动效与网格投影。设置仅在本次插件运行期间生效。</p>
      </div>
      <div className="pxo-set-card">
        ...
        {/* No slider: the matrix measures the board and uses every cell that
            fits, so capacity is derived, not chosen. A control here would be
