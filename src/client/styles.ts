...
const SETTINGS_BASE = '.pxo-settings{display:flex;flex-direction:column;gap:16px;'
  ...
  + 'font-weight:600;}'
  + '.pxo-settings-ver{display:block;margin-top:8px;font-size:10px;'
  + 'letter-spacing:1px;color:var(--dsw-alias-label-tertiary,#9ca3af);}'
...
const SETTINGS = '.pxo-settings{display:flex;flex-direction:column;gap:14px;'
  ...
  // Credit line under the hero copy. `display:block` because the base version
  // is a long string (~30 chars) — as a badge beside the kicker it would wrap.
  + '.pxo-settings-ver{display:block;margin-top:8px;font-size:9px;'
  + 'letter-spacing:2px;color:var(--pxo-dim);}'
